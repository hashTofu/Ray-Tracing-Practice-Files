...
int main() {
    ...
    // Camera setup for better viewing of vertical composition
    camera cam;
    ...
    // Position the camera to capture the floating spheres
    cam.vfov = 40; // Wider field of view to see more vertical space
    cam.lookfrom = point3(0, 4, 12); // Higher camera position
    cam.lookat = point3(0, 4, 0);    // Looking at middle height
    cam.vup = vec3(0, 1, 0);
